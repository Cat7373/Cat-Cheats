...
public class Gui_Main_Mods_Slot extends GuiSlot {
    ...
    protected void drawSlot(final int index, final int x, final int y, final int par4, final int mouseX, final int mouseY) {
        ...
        this.gui_Main.drawString(Gui_Main_Mods_Slot.minecraft.fontRendererObj, modName, x + 24, y + 6, 0x00FFFFFF);
        this.gui_Main.drawString(Gui_Main_Mods_Slot.minecraft.fontRendererObj, enable, x + 120, y + 6, 0x00FFFFFF);
        if (keyCode != Keyboard.KEY_NONE) {
            this.gui_Main.drawString(Gui_Main_Mods_Slot.minecraft.fontRendererObj, Keyboard.getKeyName(keyCode), x + 180, y + 6, 0x00FFFFFF);
        }
    }
