...
public class Gui_Main_Mods_Slot extends GuiSlot {
    ...
    protected void drawSlot(final int index, final int x, final int y, final int par4, Tessellator tessellator, final int mouseX, final int mouseY) {
        ...
        gui_Main.drawString(Gui_Main_Mods_Slot.minecraft.fontRenderer, enable, x + 120, y + 6, 0x00FFFFFF);
        if(keyCode != Keyboard.KEY_NONE) {
            gui_Main.drawString(Gui_Main_Mods_Slot.minecraft.fontRenderer, Keyboard.getKeyName(keyCode), x + 180, y + 6, 0x00FFFFFF);
        }
    }
