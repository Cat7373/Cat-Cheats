...
public class Gui_AddBlock extends GuiScreenBase {
    ...
    protected void actionPerformed(final GuiButton guiButton) {
        if (guiButton.enabled) {
            if (guiButton.id == this.btnSave.id) {
                final XrayBlock xrayBlock = new XrayBlock(this.numericBlockId.getValue(), (byte) this.numericDamage.getValue(), (byte) (this.slider_r.percent * 255), (byte) (this.slider_g.percent * 255), (byte) (this.slider_b.percent * 255), (byte) (this.slider_a.percent * 255));
                if (this.xrayBlock == null) {
                    XrayBlock.add(xrayBlock);
                } else {
                    XrayBlock.set(xrayBlock, this.xrayBlockIndex);
                }
                XrayBlock.save();
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        this.drawString(this.fontRendererObj, this.str_blockId, 5, 14, 0xFFFFFF);
        this.drawString(this.fontRendererObj, this.str_damage, 5, 34, 0xFFFFFF);

        final int color = GuiUnit.colorToARGB((byte) (this.slider_r.percent * 255), (byte) (this.slider_g.percent * 255), (byte) (this.slider_b.percent * 255), (byte) (this.slider_a.percent * 255));
    ...
    public void initGui() {
        ...
        this.numericBlockId = new GuiNumericField(this.fontRendererObj, id++, 90, 10, this.width / 3);
        ...
        this.numericDamage = new GuiNumericField(this.fontRendererObj, id++, 90, 30, this.width / 3);
